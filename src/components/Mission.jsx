  ...
  return (
    <section className="relative mx-auto max-w-[1320px] px-6 pb-32 pt-28" data-scroll="">
      ...
      <div className="mt-14 flex flex-col gap-8">
        {CARDS.map(({ hand, title, body, wrap, delay, revert }) => (
          <div
            key={title}
          ...
          >
            <div
              className={`m-card flex max-w-[720px] flex-col items-center gap-8 sm:flex-row ${revert ? 'sm:flex-row-reverse' : ''}`}
            >
              <img src={hand} alt="" className="w-[130px] flex-none" />
              <div>
