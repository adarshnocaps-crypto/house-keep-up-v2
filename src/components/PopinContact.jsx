...
export default function PopinContact() {
  ...
  return (
    <div id="contact" className={`o-popin ${open ? '-open' : ''}`}>
      <LiquidGlass className="o-popin__glass">
        <button
          type="button"
        ...
        >
          <span className="flex items-center gap-4">
            <span>
              <span className="tx-xs o-popin__label block">So, that clean</span>
              <span className="font-display o-popin__title block text-[1.35rem] leading-none">
                shall we talk?
              </span>
            </span>
          </span>
